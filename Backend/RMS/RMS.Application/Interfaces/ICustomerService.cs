...
namespace RMS.Application.Interfaces
{
    public interface ICustomerService
    {
        ...
        Task<ResponseDto<PagedResult<CustomerDto>>> GetAllAsync(int pageNumber, int pageSize, string? searchQuery, string? sortColumn, string? sortDirection, bool? status);
