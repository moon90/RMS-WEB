...
namespace RMS.Application.Interfaces
{
    public interface IInventoryService
    {
        ...
        Task<ResponseDto<PagedResult<InventoryDto>>> GetAllAsync(int pageNumber, int pageSize, string? searchQuery, string? sortColumn, string? sortDirection, bool? status, int? categoryId = null);
        ...
        Task<ResponseDto<LowStockResultDto>> GetLowStockProductsAsync(int pageNumber, int pageSize, string? searchQuery, string? sortColumn, string? sortDirection, bool? status, int? categoryId = null);
    }
}
