...
namespace RMS.Application.Interfaces
{
    public interface IStockTransactionService
    {
        ...
        Task<ResponseDto<PagedResult<StockTransactionDto>>> GetAllAsync(int pageNumber, int pageSize, string? searchQuery, string? sortColumn, string? sortDirection, bool? status);
