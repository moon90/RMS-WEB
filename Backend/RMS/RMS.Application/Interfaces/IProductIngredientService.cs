...
namespace RMS.Application.Interfaces
{
    public interface IProductIngredientService
    {
        ...
        Task<ResponseDto<PagedResult<ProductIngredientDto>>> GetAllAsync(int pageNumber, int pageSize, string? searchQuery, string? sortColumn, string? sortDirection, bool? status);
