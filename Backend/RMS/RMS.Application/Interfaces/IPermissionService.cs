...
namespace RMS.Application.Interfaces
{
    ...
    {
        Task<ResponseDto<PagedResult<PermissionDto>>> GetAllPermissionsAsync(int pageNumber, int pageSize, string? searchQuery, string? sortColumn, string? sortDirection, bool? status);
